...
function generateComponentFactory() {
  ...
  fs.readdirSync(componentRootPath).forEach((srcSubFolder) => {
    if (srcSubFolder !== "feature" && srcSubFolder !== "layouts" && srcSubFolder !== "foundation") return;
    ...
    fs.readdirSync(srcSubFolderFullPath).forEach((moduleFolder) => {
      let moduleComponentsFolderFullPath = path.join(srcSubFolderFullPath, moduleFolder, 'components');
      ...
      fs.readdirSync(moduleComponentsFolderFullPath).forEach((componentFolder) => {
        ...
        if (
          ...
          imports.push(`import ${importVarName} from '../${srcSubFolder}/${moduleFolder}/components/${componentFolder}';`);
